    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('global_reminders', models.CharField(blank=True, max_length=30, null=True)),
                ('reminders', models.TextField(blank=True, null=True)),
                ('character_type', models.CharField(choices=[('Townsfolk', 'Townsfolk'), ('Outsider', 'Outsider'), ('Minion', 'Minion'), ('Demon', 'Demon'), ('Traveller', 'Traveller'), ('Fabled', 'Fabled')], max_length=30)),
                ('edition', models.IntegerField(choices=[(0, 'Base'), (1, '+ Kickstarter'), (2, '+ Unreleased')])),
